...
# Intentamos agregar una clave que ya existe al diccionario
...
# Intentamos agregar una clave que no existe en el diccionario sin valor en el método
return_value = fruits.setdefault("kiwi")
print(f"El valor retornado de ('kiwi') es: {return_value}")
print(f"El diccionario actualizado es: {fruits} \n")

# Intentamos agregar una clave que no existe en el diccionario con valor en el método
