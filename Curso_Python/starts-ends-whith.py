...
starts_with = "Ejemplos con starts_with():"
ends_with = "Ejemplos con ends_with():"

print(f"\n{starts_with.rjust(50, '=')}")

resultado = string.startswith("D")
print(f"\n{string} comiensa con la subcadena D: {resultado}")

resultado = string.startswith("d")
print(f"\n{string} comiensa con la subcadena d: {resultado}")

resultado = string.startswith("Diana")
print(f"\n{string} comiensa con la subcadena Diana: {resultado}")

resultado = string.startswith("se", 6)
print(f"\n{string} comiensa con la subcadena se, desde la posición 6: {resultado}")

resultado = string.startswith("se", 6, 7)
print(f"\n{string} comiensa con la subcadena se, desde la posición 6 hasta la posición 7: {resultado}")

resultado = string.startswith("se", 100, 100)
print(f"\n{string} comiensa con la subcadena se, desde la posición 100 hasta la posición 100: {resultado}")

resultado = string.startswith("se", -4, -1)
print(f"\n{string} comiensa con la subcadena se, desde la posición -4 hasta la posición -1: {resultado}")
